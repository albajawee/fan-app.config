...
export const i18nData = {
  ar: {
    ...
    "section.core.desc": "الأساس الذي يُبنى عليه كل شيء، ويحتوي على أهم المميزات .",
    "section.ecommerce.title": "القسم الثاني: المتجر الإلكتروني",
    "section.ecommerce.desc": "يوفر مصدر دخل للتطبيق عبر بيع المنتجات والتذاكر.",
    "section.forum.title": "القسم الثالث: المنتدى التفاعلي",
    "section.forum.desc": "مكان للتفاعل والمشاركة بين المشجعين.",
    "section.addons.title": "الإضافات ",
